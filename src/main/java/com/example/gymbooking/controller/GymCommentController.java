...
public class GymCommentController {
    ...
    @GetMapping({"/api/comments", "/api/comments/", "/comments", "/comments/", "/api/comment", "/api/comment/", "/comment", "/comment/"})
    ...
    @PostMapping({"/api/comments", "/api/comments/", "/comments", "/comments/", "/api/comment", "/api/comment/", "/comment", "/comment/"})
    ...
    @DeleteMapping({"/api/comments/{commentId}", "/api/comments/{commentId}/", "/comments/{commentId}", "/comments/{commentId}/", "/api/comment/{commentId}", "/api/comment/{commentId}/", "/comment/{commentId}", "/comment/{commentId}/"})
