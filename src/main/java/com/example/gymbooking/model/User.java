...
public class User implements UserDetails {
    ...
    @Pattern(regexp = "^[A-Za-z\\u0400-\\u04FF\\s\\-]+$", message = "Нэр кирилл эсвэл латин үсэг, зай, ташуу зураас агуулах ёстой")
    ...
    @Pattern(regexp = "^[A-Za-z\\u0400-\\u04FF\\s\\-]+$", message = "Овог кирилл эсвэл латин үсэг, зай, ташуу зураас агуулах ёстой")
    @Column(columnDefinition = "VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci")
